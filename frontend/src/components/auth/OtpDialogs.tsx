  ...
  return (
    <Backdrop onClose={onClose}>
      ...
      <div className="px-6 py-5 space-y-3">
        ...
        <button onClick={resend} className="w-full text-xs font-semibold text-gray-500 hover:text-gray-800 py-1">
          Resend code
        </button>
      </div>
    </Backdrop>
      ...
      <div className="px-6 py-5 space-y-3">
        ...
        {step === 'done' && (
          <>
            ...
            <button onClick={onClose} className={primaryBtn} style={{ background: 'linear-gradient(135deg, #0f1e3c, #1a2d50)' }}>
              Back to sign in
            </button>
          </>
        )}
