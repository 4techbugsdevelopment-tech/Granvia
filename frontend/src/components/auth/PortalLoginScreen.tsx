// Shared admin-style desktop login used by the Super Admin, Sales Executive and
// Sub Admin portals. Design/colours/theme are identical across portals — only the
// role, card title and subtitle differ (passed as props).
          ...
          >
            ...
            >
              ...
              >
                ...
                <p className="text-blue-200 text-xs mt-1 opacity-70">{subtitle}</p>
              </div>
