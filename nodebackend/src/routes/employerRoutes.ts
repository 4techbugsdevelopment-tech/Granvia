...
router.post('/employer/applications/:application/leave-decision', asyncHandler(application.decideLeaveRequest));
router.post('/employer/applications/:application/release', asyncHandler(application.releaseAssociate));
